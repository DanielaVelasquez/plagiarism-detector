...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=4, metavar='IN',
                       help='model input features for the model (default: 4)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='H',
                       help='size of the hidden layer in the model (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='O',
                        help='output of the model (default=1)')
    parser.add_argument('--dropout', type=float, default=0.3, metavar='D',
                        help='percentage of neurons to dropout (default: 0.3)')
    ...
    model = BinaryClassifier(args.input_features, args.hidden_dim, args.output_dim, args.dropout).to(device)
